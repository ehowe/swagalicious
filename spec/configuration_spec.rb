...
require_relative "../lib/swagalicious/configuration"

describe Swagalicious::Configuration do
  ...
  describe "#swagger_root" do
    ...
    context "not provided" do
      ...
      it { expect { response }.to raise_error Swagalicious::ConfigurationError }
    end
  end
  ...
  describe "#get_swagger_doc(tag=nil)" do
    ...
    context "tag provided" do
      ...
      context "no matching doc" do
        ...
        it { expect { swagger_doc }.to raise_error Swagalicious::ConfigurationError }
      end
    end
  end
end
